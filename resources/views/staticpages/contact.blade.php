					...
					<div class="header">
						<nav class="navbar navbar-default">
							<div class="navbar-header navbar-left">
								...
								<h1><a class="navbar-brand" href="index.html">Imagelinks Travel And Tour</span></a></h1>
							</div>
...
<section class="contact-w3ls">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong> +234 8084342944</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="fly@imagelinksng.com">fly@imagelinksng.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Dolphin Estate, Ikoyi, Lagos State, Nigeria.</p>											
