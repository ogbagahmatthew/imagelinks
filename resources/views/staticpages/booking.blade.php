...
<html lang="en">
<head>
<title>Imagelinks Travel and Tour | Booking </title>
<!-- custom-theme -->
					...
					<div class="header">
						<nav class="navbar navbar-default">
							<div class="navbar-header navbar-left">
								...
								<h1><a class="navbar-brand" href="homepages">Imagelinks Travel And Tour</span></a></h1>
							</div>
								...
								<nav class="cl-effect-15" id="cl-effect-15">
									<ul class="nav navbar-nav">
										<li><a href="homepages">Home</a></li>
													...
													<li class="active"><a href="bookings">Booking</a></li>
										...
										<div class="agileinfo_main_grid held">
											<div class="agileits_w3layouts_grid">
												...
												<select id="category1" name="category1" required="">
													...
													<option value="category3">Nigeria</option>
												</select>
											</div>
										</div>
